...
abstract class _GithubRepository extends GithubRepository {
  const factory _GithubRepository(
      ...
      @JsonKey(name: 'owner') final RepositoryOwner? owner,
      ...
      @JsonKey(name: 'score') final double? score}) = _$GithubRepositoryImpl;
